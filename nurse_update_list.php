...
foreach ($stmt->fetchAll(PDO::FETCH_ASSOC) as $row) {
    $msg.="<tr><td>" . $row['name'] . "</td><td>" . $row['gender'] . "</td><td>" . $row['account'] . "</td><td>" . $row['password'] . "</td><td>" . $row['email'] . "</td><td>" . $row['tel'] . "</td><td>" . $row['job'] . "</td><td>" . $row['status'] . "</td><td><form action='nurse_update_page.php' method='POST'><input type='hidden' name='userid' value=".$row['User_ID'].">
